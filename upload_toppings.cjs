...
const filesToUpload = {
    ...
    "Uva": "topping_uva_roxa_v1_1771159519379.png", // Corrected version
    ...
    "Choco Ball": "topping_chocoball_mixed_v1_1771159506218.png", // Corrected version
...
async function main() {
    ...
    fs.writeFileSync(path.join(folder, 'topping_urls.json'), JSON.stringify(results, null, 2));
    console.log('\nAll uploads finished. Results saved to topping_urls.json');
}
